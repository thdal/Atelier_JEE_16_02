...
public class ConnexionServlet extends HttpServlet {
	...
	public void initIdeeList(Long userId) {
		if (ideeService.getIdeesList().isEmpty()) {
			// Je dois récupérer les images depuis internet je rencontre des difficultés
			// pour
			...
			this.createIdeeList("Business", "Monter une exploitation minière d'astéroïdes",
